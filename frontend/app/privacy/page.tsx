      ...
      <main className="pt-32 pb-24 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <div className="prose-aura space-y-12">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <ul className="space-y-2 font-body text-sm text-on-surface-variant leading-relaxed">
                  ...
                  <li>• AI analysis is processed by configured model providers — subject to their policies</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <PolicySection title="2. How we use your photos">
            ...
            <ul>
              <li>Photos are sent to configured AI vision providers for skin tone, body type, and face shape analysis</li>
          ...
          <PolicySection title="3. AI processing & third parties">
            ...
            <ul>
              <li><strong>AI model providers</strong> — for photo analysis, outfit generation, and visual boards where applicable.</li>
              ...
              <li><strong>OpenRouter / OpenAI-compatible APIs</strong> — for model routing and visual generation where configured.</li>
            </ul>
